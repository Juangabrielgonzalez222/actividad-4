class FechaHora():
    ...
    def PonerEnHora(self,hora=1,minutos=0,segundos=0):
        if((hora<24 and hora>-1)and (minutos<60 and minutos>-1) and(segundos<60 and segundos>-1)):
            self.__hora=hora
            self.__minutos=minutos
            self.__segundos=segundos
        else:
            print("Hora incorrecta debe ser en rango 0-23 o minutos 0-59 o segundos 0-59")
    ...
    def Test(self):
        ...
        self.PonerEnHora()
        self.PonerEnHora(5,15,23)
        self.PonerEnHora(50,12,12)
        self.PonerEnHora(15,15,15)
        self.AdelantarHora(15,15,15)
        self.Mostrar()
        self.AdelantarHora(20,20,20)
        self.Mostrar()
